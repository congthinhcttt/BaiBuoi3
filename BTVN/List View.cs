...
namespace BTVN
{
    public partial class Form1 : Form
    {
        ...
        {
            FormNhanVien form2 = new FormNhanVien(); // Tạo mới Form2 để thêm nhân viên
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0) // Kiểm tra có dòng được chọn không
            {
                ...
                FormNhanVien form2 = new FormNhanVien(nv);
                if (form2.ShowDialog() == DialogResult.OK) // Chờ người dùng nhấn "Đồng ý"
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0) // Kiểm tra có dòng được chọn không
            {
                ...
                FormNhanVien form2 = new FormNhanVien(nv, isDelete: true); // Truyền thêm flag isDelete
                if (form2.ShowDialog() == DialogResult.OK) // Chờ người dùng nhấn "Đồng ý"
                {
